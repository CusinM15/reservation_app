...
Privzeti dostop: uporabniško ime `admin`, geslo `admin123` (**geslo takoj spremeni!**).
...
✅ **Geslo admin uporabnika takoj spremeni.** Privzeto geslo `admin123` ve vsak, ki prebere to dokumentacijo.
